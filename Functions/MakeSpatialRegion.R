...
MakeSpatialRegion <- function (data = NULL, coords = c("X", "Y"), meshpars, bdry = NULL, 
  ...
  #convert polygon boundary to inla.mesh.segment object
  ...
  #create inla.spde2 model object 
  spde <- inla.spde2.matern(mesh = mesh, alpha = 2)
  
  #Calculate Delaunay triangulation for the mesh
  dd <- deldir::deldir(mesh$loc[, 1], mesh$loc[, 2])
  
  #Create list of tiles containing the point being tesselated
